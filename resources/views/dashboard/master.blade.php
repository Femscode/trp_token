...
<head>
  ...
  <!-- Favicon icon-->
  <link rel="apple-touch-icon" sizes="180x180" href="{{url('assets/images/trp.png')}}" />
  <link rel="icon" type="image/png" sizes="32x32" href="{{url('assets/images/trp.png')}}" />
  <link rel="icon" type="image/png" sizes="16x16" href="{{url('assets/images/trp.png')}}" />
  ...
  <link rel="shortcut icon" href="{{url('assets/images/trp.png')}}" />
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="collapse d-md-block" id="collapseAccountMenu">
              <ul class="nav flex-column nav-account">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/admin/allwallets">
                    <i class="align-bottom bx bx-box"></i>
                    <span class="ms-2">Connected Wallets</span>
                  </a>
                </li>
      ...
      <div class="row align-items-center">
        <div class="col-md-3">
          <a class="mb-4 mb-lg-0 d-block text-inverse" href="/">
            <img src="{{url('assets/images/trp.png')}}" style='width:50px;height:50px' alt="" />
          </a>
        </div>
        <div class="col-md-9 col-lg-6">
          <div class="small mb-3 mb-lg-0 text-lg-center">
            ...
            <span class="text-primary"><a href="#">TRP Token Distribution</a></span>
